...
class raceDemogData {
  public:
      ...
      raceDemogData& operator+=(const raceDemogData rd) {
        raceDemogData *addedData;
        addedData->FirstNationCount = this->FirstNationCount + rd.FirstNationCount;
        addedData->AsianCount = this->AsianCount + rd.AsianCount;
        addedData->BlackCount = this->BlackCount + rd.BlackCount;
        addedData->LatinxCount = this->LatinxCount + rd.LatinxCount;
        addedData->HIPacificIsleCount = this->HIPacificIsleCount + rd.HIPacificIsleCount;
        addedData->MultiRaceCount = this->MultiRaceCount + rd.MultiRaceCount;
        addedData->WhiteCount = this->WhiteCount + rd.WhiteCount;
        addedData->WhiteNHCount = this->WhiteNHCount + rd.WhiteNHCount;
        addedData->otherCount = this->otherCount + rd.otherCount;
        addedData->communityCount = this->communityCount + rd.communityCount;
        return *addedData;
    }
